...
> [!NOTE]
> Since no User Interface (UI) was specified in the [problemstatement.md], this project was developed as a pure backend API system. You can explore, call, and test all functional features using the built-in Swagger UI at `http://127.0.0.1:8000/docs`.
